...
export async function GET(
  ...
  try {
    const res = await fetch(`${getAdminApiUrl()}/api/blog/posts/${id}`, {
    ...
    console.error("Blog post detail proxy error:", e);
...
export async function PUT(
  ...
  try {
    ...
    console.error("Blog post update proxy error:", e);
    return NextResponse.json(
      { detail: "Internal server error" },
      { status: 500 }
    );
...
export async function DELETE(
  ...
  try {
    ...
    console.error("Blog post delete proxy error:", e);
    return NextResponse.json(
      { detail: "Internal server error" },
      { status: 500 }
    );
