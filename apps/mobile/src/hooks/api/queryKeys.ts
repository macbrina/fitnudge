...
export const goalsQueryKeys = {
  ...
  byCategory: (category: string) => [...goalsQueryKeys.all, "category", category] as const,
...
export const actionablePlansQueryKeys = {
  ...
  // Goal plan keys
  planStatus: (goalId: string) => ["actionable-plans", "status", goalId] as const,
...
export const challengesQueryKeys = {
  ...
  leaderboard: (id: string) => [...challengesQueryKeys.all, "leaderboard", id] as const,
  participants: (id: string) => [...challengesQueryKeys.all, "participants", id] as const,
  checkIns: (id: string) => [...challengesQueryKeys.all, "check-ins", id] as const,
  myCheckIns: (id: string) => [...challengesQueryKeys.all, "my-check-ins", id] as const
} as const;
