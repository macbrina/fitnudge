...
export default function CreateGoalScreen() {
  ...
  // Show upgrade prompt ONLY on initial load, not after goal creation
  useEffect(() => {
    ...
    // Show upgrade prompt if user is at their limit when entering the screen
    if (!canCreate && plan === "free") {
      setShowUpgradePrompt(true);
    }
  }, [isLoadingGoals, canCreate, plan]);
