...
export function PlanSection({
  ...
  const { data: challengeStatusData, isLoading: challengeStatusLoading } =
    useChallengePlanStatus(challengeId, !propPlanStatus && isChallenge);
      ...
      <Card shadow="md" style={styles.restrictedCard}>
        ...
        <View style={styles.restrictedInfo}>
          ...
          <View style={styles.restrictedInfoItem}>
            ...
            />
            <Text style={styles.restrictedInfoText}>
              {t("partners.can_view_progress") ||
                "You can view their progress stats"}
            </Text>
          </View>
        </View>
      </Card>
  ...
  if (status === "completed" && plan) {
                ...
                {(() => {
                                  ...
                                  <View key={index} style={styles.timelineItem}>
                                    ...
                                    {!isLast && (
                                      <View
                                        style={[
                                          ...
                                          isAchieved &&
                                            styles.timelineConnectorAchieved,
                                        ]}
                                      />
                                    )}
                                      ...
                                      {isAchieved ? (
                                        ...
                                        <Text
                                          style={[
                                            ...
                                            isCurrent &&
                                              styles.timelineNodeTextCurrent,
                                          ]}
                                        >
                                          {milestone.days}
                                        </Text>
                                    ...
                                    <View
                                      style={[
                                        ...
                                        isAchieved &&
                                          styles.timelineMilestoneContentAchieved,
                                      ]}
                                    >
                                      <View
                                        style={styles.timelineMilestoneHeader}
                                      >
                                        <Text
                                          style={[
                                            styles.timelineMilestoneTitle,
                                            isAchieved &&
                                              styles.timelineMilestoneTitleAchieved,
                                          ]}
                                        >
                                          {milestone.title}
                                        </Text>
                                      ...
                                      <Text
                                        style={[
                                          ...
                                          isAchieved &&
                                            styles.timelineMilestoneDescAchieved,
                                        ]}
                                      >
                  ...
                  return (
                    <>
                      ...
                      {challengeInfo?.duration_days && (
                        <View style={styles.challengeDuration}>
                          ...
                          <Text style={styles.challengeDurationText}>
                            ...
                            {Math.ceil(challengeInfo.duration_days / 7)}{" "}
                            {t("common.weeks")}
                          </Text>
                        </View>
                      )}
                      ...
                      {challengeInfo?.milestones &&
                        challengeInfo.milestones.length > 0 && (
                          <View style={styles.timeMilestones}>
                            <Text style={styles.tabSectionTitle}>
                              {t("goals.plan.milestones")}
                            </Text>
                            {challengeInfo.milestones.map(
                              (milestone: any, index: number) => (
                                <View
                                  key={index}
                                  style={styles.timeMilestoneItem}
                                >
    ...
    const trackingType = (structuredData as any).tracking_type as
      | string
      | undefined;
