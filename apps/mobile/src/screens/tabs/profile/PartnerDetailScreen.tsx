...
export function PartnerDetailScreen() {
  ...
  useEffect(() => {
    if (dashboard && !isStillPartner && partnersData?.data) {
      showToast({
        ...
        message:
          t("partners.partnership_removed_message") ||
  ...
  const handleNudgePartner = () => {
    showToast({
      ...
      message:
        ...
        "Your partner will be notified to stay on track",
      variant: "success",
    });
  };
  ...
  const renderGoalCard = (goal: PartnerGoalSummary, index: number) => {
    const categoryColor =
      CATEGORY_COLORS[goal.category] || CATEGORY_COLORS.fitness;
  ...
  const renderChallengeCard = (
    challenge: PartnerChallengeSummary,
    index: number,
  ) => {
    const categoryColor =
      CATEGORY_COLORS[challenge.category || "fitness"] ||
      ...
      >
        ...
        <View style={styles.profileSection}>
          ...
          <View style={styles.avatarWrapper}>
            ...
            {partner.profile_picture_url ? (
              <Image
                source={{ uri: partner.profile_picture_url }}
                style={styles.avatar}
              />
            ) : (
              <View
          ...
          {/* Name & Username */}
          {partner.username && (
            <Text style={styles.profileUsername}>@{partner.username}</Text>
          )}
          <Text style={styles.profileName}>
            {partner.name || t("partners.unknown_user")}
          </Text>
        ...
        <View style={styles.statsGrid}>
          ...
          <View style={styles.statCard}>
            ...
            <Text style={styles.statLabel}>
              {t("partners.active_goals") || "Active Goals"}
            </Text>
          </View>

          <View style={styles.statCard}>
            <Text style={styles.statValue}>
              {dashboard.total_active_challenges}
            </Text>
            <Text style={styles.statLabel}>
              {t("partners.challenges") || "Challenges"}
            </Text>
          </View>
          ...
          <View style={styles.statCard}>
            {has_scheduled_today === false ? (
              ...
              <>
                ...
                <Text style={styles.statLabel}>
                  {t("partners.logged_today") || "Logged Today"}
                </Text>
              </>
            )}
          </View>
          ...
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              <Text style={styles.sectionTitle}>
                {t("partners.their_goals") || "Their Goals"}
              </Text>
        ...
        <View style={styles.infoCard}>
          <Text style={styles.infoCardTitle}>
            {t("partners.accountability_info_title") ||
          ...
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoTextSmall}>
              {t("partners.info_nudge") ||
                "Send nudges to encourage them to stay on track"}
            </Text>
          </View>
          <View style={styles.infoRow}>
            <View style={styles.infoIconSmall}>
            ...
            <Text style={styles.infoTextSmall}>
              {t("partners.info_notifications") ||
                "Get notified when they achieve milestones"}
            </Text>
          </View>
        </View>
      </ScrollView>
