...
import { useChallenge, useChallengeLeaderboard } from "@/hooks/api/useChallenges";
...
export default function LeaderboardScreen() {
  ...
  // Data hooks
  const { data: challengeResponse, isLoading: challengeLoading } = useChallenge(challengeId || "");
            ...
            <View style={styles.myPositionLeft}>
              ...
              <View>
                ...
                <Text style={styles.myPositionSubtext}>
                  {myEntry.points} {t("challenges.points") || "pts"} • {myEntry.total_check_ins}{" "}
                  {t("checkin.check_ins") || "check-ins"}
                </Text>
              </View>
            </View>
            {myEntry.rank <= 3 && (
              <Ionicons name="medal" size={32} color={getMedalColor(myEntry.rank) || undefined} />
            )}
          </View>
        </Card>
      )}
    ...
    return (
      <View style={[styles.entryRow, isMe && styles.entryRowHighlighted]}>
        ...
        <View style={styles.entryContent}>
          <Text style={[styles.userName, isMe && styles.userNameHighlighted]} numberOfLines={1}>
        ...
        <View style={styles.pointsContainer}>
          <Text style={[styles.points, isMe && styles.pointsHighlighted]}>{item.points}</Text>
