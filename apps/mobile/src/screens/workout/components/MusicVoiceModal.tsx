    ...
    >
      <View style={[styles.container, { paddingTop: insets.top }]}>
        ...
        <View style={styles.header}>
          <Text style={styles.title}>{t("workout.music_voice_title", "Music & Voice")}</Text>
        ...
        >
          ...
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              <Text style={styles.sectionTitle}>{t("workout.music", "Music")}</Text>
              <Switch
                value={preferences.music_enabled}
                onValueChange={(value) => onUpdatePreferences({ music_enabled: value })}
                trackColor={{
              ...
              <>
                ...
                <View style={styles.playbackControls}>
                  ...
                  >
                    <Ionicons
                      name="shuffle"
                      size={24}
                      color={isShuffleOn ? brandColors.primary : colors.text.primary}
                    />
                  </TouchableOpacity>

                  <TouchableOpacity style={styles.controlButton} disabled>
                    <Ionicons name="repeat" size={24} color={colors.text.tertiary} />
                  </TouchableOpacity>
                </View>
                ...
                <View style={styles.volumeRow}>
                  ...
                  <VolumeSlider
                    ...
                    onValueChange={(value) => onUpdatePreferences({ music_volume: value })}
                ...
                <View style={styles.musicSourceRow}>
                  ...
                  >
                    <Text style={styles.musicSourceText}>{t("workout.playlist", "Playlist")}</Text>
                  </TouchableOpacity>
          ...
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              <Text style={styles.sectionTitle}>{t("workout.coach_voice", "Coach Voice")}</Text>
              <Switch
                value={preferences.coach_voice_enabled}
                onValueChange={(value) => onUpdatePreferences({ coach_voice_enabled: value })}
                trackColor={{
                  false: colors.border.subtle,
                  true: brandColors.primary
                }}
            ...
            {preferences.coach_voice_enabled && (
              <View style={styles.volumeRow}>
                ...
                <VolumeSlider
                  ...
                  onValueChange={(value) => onUpdatePreferences({ coach_voice_volume: value })}
                  minimumTrackTintColor={brandColors.primary}
                  maximumTrackTintColor={colors.border.subtle}
                  thumbTintColor="#FFFFFF"
                />
            ...
            <View style={styles.sectionHeader}>
              <View>
                ...
                <Text style={styles.sectionSubtitle}>
                  {t("workout.sound_effects_desc", "'Ding' sound after exercises, etc.")}
                </Text>
              </View>
              <Switch
                value={preferences.sound_effects_enabled}
                onValueChange={(value) => onUpdatePreferences({ sound_effects_enabled: value })}
                trackColor={{
                  false: colors.border.subtle,
                  true: brandColors.primary
                }}
            ...
            {preferences.sound_effects_enabled && (
              <View style={styles.volumeRow}>
                ...
                <VolumeSlider
                  ...
                  onValueChange={(value) => onUpdatePreferences({ sound_effects_volume: value })}
                  minimumTrackTintColor={brandColors.primary}
                  maximumTrackTintColor={colors.border.subtle}
                  thumbTintColor="#FFFFFF"
                />
        ...
        {/* Done Button */}
        <View style={[styles.footer, { paddingBottom: insets.bottom + toRN(tokens.spacing[4]) }]}>
          <Button
