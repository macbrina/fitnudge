    ...
    >
        ...
        <View style={styles.headerContent}>
          ...
          <View
            style={[
              ...
              { marginTop: insets.top + toRN(60) },
            ]}
          >
            <Text style={styles.mainTitle}>
              {t("completion.summary.workout")}
            </Text>
            <Text style={styles.mainTitle}>
              {t("completion.summary.completed")}
            </Text>
          ...
          <Text style={styles.dayNumber}>
            {t("completion.summary.day", { number: dayNumber })}
          </Text>
        </View>
      </Animated.View>
      ...
      >
        <View style={styles.statItem}>
          ...
          <Text style={styles.statLabel}>
            {t("completion.summary.exercises")}
          </Text>
        </View>
      ...
      {completionPercent === 100 && stats.exercisesSkipped === 0 && (
        <View style={styles.completionBadge}>
          ...
          <Text style={styles.completionBadgeText}>
            {t("completion.summary.perfect_workout")}
          </Text>
        </View>
      )}
      ...
      <View style={styles.feedbackSection}>
        <Text style={styles.feedbackTitle}>
          {t("completion.summary.how_do_you_feel")}
        </Text>
              ...
              >
                ...
                >
                  <Ionicons
                    ...
                    size={24}
                    color={
                      isSelected ? brandColors.primary : colors.text.tertiary
                    }
                  />
                </View>
                <Text
                  style={[
                    ...
                    isSelected && styles.feedbackLabelSelected,
                  ]}
                >
                  {t(option.labelKey)}
                </Text>
