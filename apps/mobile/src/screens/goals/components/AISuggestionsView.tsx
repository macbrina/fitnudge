...
export function AISuggestionsView({
  ...
  // challenge_create = Starter+, group_goals = Pro+
  // If either feature exists in user's features, they have premium access
  const hasPremiumAccess =
    subscriptionStoreInstance.hasFeature("challenge_create") ||
    subscriptionStoreInstance.hasFeature("group_goals");
    ...
    try {
      ...
      if (generationLimit !== null && currentCount >= generationLimit) {
        ...
        const confirmed = await showConfirm({
          ...
          cancelLabel: t("goals.create.suggestions.use_custom"),
          variant: "info",
          showCloseIcon: true,
        });
