...
import { PRIMARY_GOALS } from "@/constants/personalization";
  ...
  return (
    ...
    >
      <View style={styles.content}>
        <Text style={styles.title}>{t("onboarding.personalization.primary_goal.title")}</Text>

        <Text style={styles.subtitle}>{t("onboarding.personalization.primary_goal.subtitle")}</Text>
