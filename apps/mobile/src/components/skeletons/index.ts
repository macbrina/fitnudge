export { PartnerDetailSkeleton } from "./PartnerDetailSkeleton";
export { SingleGoalSkeleton } from "./SingleGoalSkeleton";
export { RecapDetailSkeleton } from "./RecapDetailSkeleton";
