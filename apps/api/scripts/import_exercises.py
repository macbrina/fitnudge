...
def import_exercises():
    ...
    for i in range(0, total_exercises, batch_size):
        ...
        for exercise in batch:
            try:
                ...
                record = {
                    ...
                    # GIF paths (relative to static directory)
                    "gif_url_180": f"/static/exercises/180/{exercise['id']}.gif",
                    "gif_url_360": f"/static/exercises/360/{exercise['id']}.gif",
                    "usage_count": 0,
                    "last_used_at": None,
                }
        ...
        try:
            ...
            print(f"✅ Batch {batch_num}/{total_batches}: {imported_count}/{total_exercises} exercises ({progress:.1f}%)")
    ...
    print(f"🎞️  GIFs available: 180px and 360px resolutions")
    print()
    print("🔗 GIF URLs format:")
    print(f"   https://api-dev.fitnudge.app/static/exercises/360/0001.gif")
    print(f"   https://api.fitnudge.app/static/exercises/360/0001.gif")
    print()
    print("📝 Next steps:")
    print("   1. Test GIF access in browser")
    print("   2. Update plan generator to use exercises")
    print("   3. Create ExerciseCard component in mobile app")
    print("="  * 60)
