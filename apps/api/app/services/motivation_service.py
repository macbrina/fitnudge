...
# =============================================================================
# BACKGROUND STYLE → COLOR MAPPING
# =============================================================================
...
def _get_rest_day_templates(user_name: str, style: str) -> str:
    ...
    templates = {
        "supportive": [
            f"Rest well, {user_name}! Recovery is part of the journey. 🧘",
...
def _get_completed_templates(user_name: str, streak: int, style: str) -> str:
    ...
    if streak >= 30:
        templates = {
            "supportive": [
                f"Incredible, {user_name}! {streak} days! You're unstoppable! 🔥",
                f"LEGEND status, {user_name}! {streak} days strong! 👏",
        ...
        templates = {
            "supportive": [
                f"Two weeks strong, {user_name}! {streak} days and counting! 💪",
                f"You're on fire! {streak} days of pure dedication, {user_name}!",
                f"This is becoming a habit, {user_name}! Keep it up! 🌟",
            ],
            "tough_love": [
        ...
        templates = {
            "supportive": [
                f"A whole week, {user_name}! {streak} days! Amazing! 🎉",
                f"You're building momentum! {streak} days strong! ⭐",
        ...
        templates = {
            "supportive": [
                f"Yes! {streak} days in a row, {user_name}! The momentum is building! 💪",
        ...
        templates = {
            "supportive": [
                f"Well done, {user_name}! Every step forward counts! ✨",
                f"You showed up today, {user_name}! That's what matters! 🙌",
...
def _get_missed_templates(user_name: str, style: str) -> str:
    ...
    templates = {
        "supportive": [
            f"It's okay, {user_name}. Tomorrow is a new chance. 💙",
